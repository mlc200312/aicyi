...
public class RedisCacheManagerTest extends BaseLoggerTest {
    ...
    private StringCacheManager<String> redisCacheManager;

    @Before
    public void before() {
        redisCacheManager = new RedisCacheFactory(redisConnectionFactory).createCache("cache", CacheConfig.defaultConfig(), String.class);
    }

    @Test
    public void test() {
        redisCacheManager.put("test_put", "tes put");
        String testPut = redisCacheManager.get("test_put");
        ...
        String removeTestPut = redisCacheManager.get("test_put");
        ...
        String testPut01 = redisCacheManager.get("test_put_01", key -> {
        ...
        String testPut02 = redisCacheManager.getAndRemove("test_put_02");
        ...
        String testPut03 = redisCacheManager.getAndReplace("test_put_03", "tes put 04");

        assert testPut03.equals("tes put 03");

        String newTestPut03 = redisCacheManager.get("test_put_03");
    ...
    public void testPutAll() {
        ...
        Map<String, String> testPutAll = redisCacheManager.getAll(map.keySet());
        ...
        Map<String, String> removeTestPutAll = redisCacheManager.getAll(map.keySet());
