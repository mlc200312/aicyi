...
public class MessageSendResult extends BaseBean {
    ...
    private MessageSendResult(Builder builder) {
    ...
    public static class Builder {
         ...
         */
        public MessageSendResult buildSuccess(String messageId, String channelMessageId) {
            this.success = true;
            this.messageId = messageId;
            this.channelMessageId = channelMessageId;
            this.errorCode = null;
            this.errorMsg = null;
            return new MessageSendResult(this);
        }

        /**
         * 构建 SendResult 实例（失败结果）
         */
        public MessageSendResult buildFailure(String errorCode, String errorMsg) {
            this.success = false;
         ...
         */
        public MessageSendResult build() {
            return new MessageSendResult(this);
        }
    }
