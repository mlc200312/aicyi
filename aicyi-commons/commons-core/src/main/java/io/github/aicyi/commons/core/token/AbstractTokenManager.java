 ...
 * @date 18:20
 **/
public abstract class AbstractTokenManager<V> implements TokenManager<String, V> {

    protected final TokenConfig config;
    protected final TokenGenerator<String> tokenGenerator;

    public AbstractTokenManager(TokenConfig config, TokenGenerator<String> tokenGenerator) {
        this.config = config;
