...
public class EasyExcelUtilsTest extends BaseLoggerTest {
    ...
    public void exportToBytesTest() {
        ...
        byte[] bytes = EasyExcelUtils.exportToBytes("12123", studentExcelList, StudentExcel.class);
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(bytes)) {
            Files.copy(inputStream, path, StandardCopyOption.REPLACE_EXISTING);
        }
        List<StudentExcel> readStudentExcelList = EasyExcelUtils.readFromBytes(bytes, StudentExcel.class);
    ...
    public void exportToFileTest() {
        ...
        EasyExcelUtils.exportToFile(path, "123", studentExcelList, StudentExcel.class);
    }
}
