...
public class RedisCacheManagerTest extends BaseLoggerTest {
    ...
    public void test() {
        ...
        log(testPut, containsTestPut, expire, removeTestPut, containsRemoveTestPut, testPut01, testPut02, containsTestPut02, testPut03, newTestPut03);
    }
    ...
    public void test2() {
        ...
        log(testPutAll, keys, size, removeTestPutAll, removeKeys, removeSize);
    }
}
